...
var index = 3;
var value = 65;
function arryIndexParameter(array, index, value) {
    array.splice(index, 0, value);
    return array;
}
var modified = arryIndexParameter(array, index, value);
...
var cart = ["Apple", "Grapes", "Orange", "Dates", " PineApple"];
function addItems() {
...
var arrayNum = [10, 15, 20, 25, 30];
var result = calculateSum(arrayNum);
console.log(result);
